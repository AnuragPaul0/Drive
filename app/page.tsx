...
export default function Home() {
  ...
  <clipboard-copy id="clipboard-button" aria-label="Copy" type="button" value="Text to copy" data-view-component="true" class="Button--secondary Button--medium Button">
...
</span><tool-tip id="tooltip-47ec3eb3-b354-45e8-87b5-43045b55d353" for="clipboard-button" popover="manual" data-direction="s" data-type="description" data-view-component="true" class="sr-only position-absolute">Copy some text</tool-tip>
