...
try{ (BidiAlert as any).displayName ||= 'BidiAlert' } catch {}
// try{ (BidiTooltip as any).displayName ||= 'BidiTooltip' } catch {}
try{ (BidiCharacter as any).displayName ||= 'BidiCharacter' } catch {}