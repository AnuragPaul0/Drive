...
// import type {CodeSymbol, TreeNode} from '@github-ui/code-nav' bad

// import {AllShortcutsEnabled} from '@github-ui/code-view-shared/components/AllShortcutsEnabled'
// import {useReposAnalytics} from '@github-ui/code-view-shared/hooks/use-repos-analytics' bad
...
// import {CodeNavSymbolTree} from './CodeNavSymbolTree' nr
...
// try{ (CodeNavSymbolNavigation as any).displayName ||= 'CodeNavSymbolNavigation' } catch {}
// try{ (JumpToActionList as any).displayName ||= 'JumpToActionList' } catch {}