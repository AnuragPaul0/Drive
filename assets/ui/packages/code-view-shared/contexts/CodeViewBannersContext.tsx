...
//   const value = useMemo(() => ({banners, addBanner, addQueuedBanner}),
//     [addBanner, addQueuedBanner, banners])
...
// try{ (CodeViewBannersProvider as any).displayName ||= 'CodeViewBannersProvider' } catch {}